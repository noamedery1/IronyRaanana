    ...
    return (
        <div dir="rtl" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: 'radial-gradient(circle at 50% 0%, #0d1530, #070b16 70%)', fontFamily: 'Rubik, sans-serif', padding: '1rem' }}>
            <div style={{ background: 'rgba(12,19,36,0.96)', padding: '2rem 1.6rem', borderRadius: '20px', boxShadow: '0 30px 70px -20px rgba(0,0,0,0.9)', border: '1px solid rgba(255,255,255,0.08)', width: '90%', maxWidth: '380px', textAlign: 'center' }}>
                <div style={{ width: 60, height: 60, margin: '0 auto 0.9rem', borderRadius: 16, background: 'linear-gradient(135deg,#ff7a18,#c2410c)', display: 'grid', placeItems: 'center', fontSize: 28 }}>🏀</div>
                ...
                <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
                    ...
                    <button type="submit" disabled={loading} style={{ background: 'linear-gradient(135deg,#ff7a18,#c2410c)', color: '#fff', border: 'none', padding: '0.85rem', borderRadius: '12px', fontWeight: 800, fontFamily: 'inherit', fontSize: '1rem', cursor: loading ? 'wait' : 'pointer', marginTop: '0.3rem' }}>
