    ...
    return (
        <div className="report-panel" style={{ marginTop: 0, color: '#0f1b33' }}>
            ...
            <p style={{ color: '#475569', maxWidth: 640 }}>
                בתצוגה המקדימה אתה בונה את הלו"ז ל<b>שבוע שבחרת</b> (לפי "תאריך התחלה"). בלחיצת <b>פרסם</b>
                הטיוטה הופכת ל<b>לוז החי</b> שכל ההורים רואים, לאותו שבוע, והגרסה הקודמת עוברת לארכיון.
                הטיוטה נשמרת על <b>אותו שבוע</b> — אז אפשר לפרסם שוב באותו יום כדי לעדכן את אותו שבוע
                (בלי קפיצה לשבוע הבא). כדי להכין את <b>השבוע הבא</b> — שנה את "תאריך התחלה" בתצוגה המקדימה ופרסם.
            </p>
