...
export default function QuickStart({ go }) {
    ...
    const steps = [
        { key: 'teams', done: s.teams > 0, tab: 'teamsAdmin', icon: '👥', title: 'הקמת קבוצות', desc: 'הוסף את קבוצות המועדון (שם, מאמן, בנים/בנות).', count: s.teams && `${s.teams} קבוצות` },
        ...
        { key: 'trainers', done: s.trainers > 0, tab: 'trainersAdmin', icon: '👤', title: 'הקמת מאמנים', desc: 'הוסף מאמנים ושייך אותם לקבוצות (עם קוד כניסה).', count: s.trainers && `${s.trainers} מאמנים` },
